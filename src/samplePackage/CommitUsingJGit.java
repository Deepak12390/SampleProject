...
public class CommitUsingJGit {
	...
	public static void main(String[] args) throws IOException, GitAPIException {
		...
		Repository existingRepo = new FileRepositoryBuilder().setGitDir(new File("C:/eclipse/Workspace/SampleDemo/.git")).build();
		...
		System.out.println("\n>>> Committing changes\n");
		RevCommit revCommit = git.commit().setOnly("src/samplePackage/HelloWorld.java").setMessage("Adding commit from JGIT")
				.call();
